...
exports.demoSignWindow1 = void 0;
    ...
    const tasks = new listr_1.default([
        {
            ...
            task: async (ctx) => {
                ...
                ctx.dataBin = await fs_1.promises.readFile(`${RAW_DATA_FOLDER}data_bin_1.txt`, "utf8");
                ctx.prevHash = await fs_1.promises.readFile(`${RESULTS_FOLDER}startup_inithash_hex.txt`, "utf8");
        ...
        },
        {
            ...
            task: async (ctx, task) => {
                try {
                    ...
                    if (!ctx.verified1) {
                        // user/deviceuser pair is registered.
        ...
        },
        {
            title: 'Save to local',
            task: async (ctx) => {
                await fs_1.promises.writeFile(`${RESULTS_FOLDER}demo_s1.txt`, ctx.signature1, 'utf8');
                await fs_1.promises.writeFile(`${RESULTS_FOLDER}demo_s2.txt`, ctx.signature2, 'utf8');
                await fs_1.promises.writeFile(`${RESULTS_FOLDER}window2_prevhash_hex.txt`, ctx.blockHash, 'utf8');
            }
        },
    ]);
...
exports.demoSignWindow1 = demoSignWindow1;
//# sourceMappingURL=demoSignWindow1.js.map